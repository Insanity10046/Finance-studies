...
benchmark = yfinance.download(SYMBOL, start='1999-01-01', end='2010-01-30', interval='1d')
...
def strategy(benchmark, i):
    global position, capital, take_profit, stop_loss, entry_price, losses, wins, rr1, rr2
